...
- Feature-flagged modules such as the voice channel session tracker (toggle via `VOICE_SESSIONS_ENABLE` and auto-create the backing table via `VOICE_SESSIONS_AUTO_MIGRATE`)
