...
const LeaderboardSBOrg = require('../models/leaderboardSBOrgModel');

// GET all leaderboard entries
exports.getAllLeaderboardEntries = async (req, res) => {
    try {
        const entries = await LeaderboardSBOrg.findAll();
...
exports.getLeaderboardEntryById = async (req, res) => {
    try {
        const entry = await LeaderboardSBOrg.findByPk(req.params.id);
        if (entry) {
...
exports.createLeaderboardEntry = async (req, res) => {
    try {
        const newEntry = await LeaderboardSBOrg.create(req.body);
...
exports.deleteAllLeaderboardEntries = async (req, res) => {
    try {
        await LeaderboardSBOrg.destroy({ where: {}, truncate: true });
...
exports.createLeaderboardEntriesBulk = async (req, res) => {
    try {
        ...
        const newEntries = await LeaderboardSBOrg.bulkCreate(entries);
