...
const ItemsComponents = require('../models/itemsComponentsModel');
...
exports.list = async (req, res) => {
    try {
        ...
        const rows = await ItemsComponents.findAll({
            where,
...
exports.get = async (req, res) => {
    try {
        const row = await ItemsComponents.findByPk(req.params.id);
...
exports.create = async (req, res) => {
    try {
        ...
        const created = await ItemsComponents.create(payload);
...
exports.update = async (req, res) => {
    try {
        ...
        const [count, [updated]] = await ItemsComponents.update(payload, {
...
exports.remove = async (req, res) => {
    try {
        const deleted = await ItemsComponents.destroy({ where: { id: req.params.id } });
