...
const ItemsFps = require('../models/itemsFpsModel');
...
exports.list = async (req, res) => {
    try {
        ...
        const rows = await ItemsFps.findAll({
            where,
...
exports.get = async (req, res) => {
    try {
        const row = await ItemsFps.findByPk(req.params.id);
...
exports.create = async (req, res) => {
    try {
        ...
        const created = await ItemsFps.create(payload);
...
exports.update = async (req, res) => {
    try {
        ...
        const [count, [updated]] = await ItemsFps.update(payload, {
...
exports.remove = async (req, res) => {
    try {
        const deleted = await ItemsFps.destroy({ where: { id: req.params.id } });
